...
# Версія: 1.0
#
# Цей скрипт адаптований для роботи в Termux (Android):
# - Використовує pkg замість apt для управління пакетами
# - Не потребує sudo (Termux надає прямий доступ)
# - Виключає GUI залежності (GTK, X11)
